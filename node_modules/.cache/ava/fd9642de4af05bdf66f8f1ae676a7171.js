...
ava('72.21.196.65', test => {
  ...
  test.is(ip.asCidr, '72.21.196.65');
});

let test0 = new IPv4('72.21.196.65');
console.log(test0.asString);
console.log(test0.asInt);
console.log(test0.asCidr);

let test1 = new IPv4(1209386049);
console.log(test1.asString);
console.log(test1.asInt);
...
//# sourceMappingURL=../node_modules/.cache/ava/fd9642de4af05bdf66f8f1ae676a7171.js.map