...
ava('10.0.255.255', test => {
  ...
  let ip0 = new IPv4(4294901760);
  console.log(ip0.asString);
  let ip1 = new IPv4('255.255.192.0');
  console.log(ip1.asInt);
  console.log(ip1.asBinary);
  console.log(ip1);
  let ip2 = new IPv4('255.255.255.255');
  console.log(ip2.asInt);
  console.log(ip2.asBinary);
  console.log(ip2);
...
//# sourceMappingURL=../node_modules/.cache/ava/0da16a2296f489004c13a2b9dba416da.js.map